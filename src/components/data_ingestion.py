...
class DataIngestion:
    ...
    def save_clean_data(self,df):
        try:
            ...
            train_set,test_set=train_test_split(df,test_size=0.2,random_state=42,stratify=df['churned'])
    ...
    def initiate_data_ingestion(self):
        try:
            ...
            train_path,test_path,merge_path=self.save_clean_data(integrated_df)
            logging.info("Data Ingestion Completed Successfully")
            return(train_path,test_path,merge_path)
...
if __name__=='__main__':
    obj=DataIngestion()
    train_path,test_path,merge_path=obj.initiate_data_ingestion()
    print(train_path)
    print(test_path)
    print(merge_path)